...
class InvoiceItemRepositoryTest < Minitest::Test
  ...
  def test_it_finds_the_first_example_of_invoice_item_by_item_id
    ...
    first_invoice_item = repo.find_invoice_item_by_item_id(500)

    assert_equal [1], [first_invoice_item.id]

    second_invoice_item = repo.find_invoice_item_by_item_id(520)
  ...
  def test_it_finds_all_examples_of_invoice_items_by_item_id
    ...
    five_hundreds = repo.find_all_invoice_items_by_item_id(500)
    five_twentys = repo.find_all_invoice_items_by_item_id(520)
    six_hundreds = repo.find_all_invoice_items_by_item_id(600)
  ...
  def test_it_finds_the_first_example_of_invoice_item_by_invoice_id
    ...
    first_invoice_item = repo.find_invoice_item_by_invoice_id(1)

    assert_equal [1], [first_invoice_item.id]

    second_invoice_item = repo.find_invoice_item_by_invoice_id(2)
    assert_equal [2], [second_invoice_item.id]
  ...
  def test_it_finds_all_examples_of_invoice_items_by_invoice_id
    ...
    invoice_ones = repo.find_all_invoice_items_by_invoice_id(1)
    invoice_twos = repo.find_all_invoice_items_by_invoice_id(2)
    invoice_threes = repo.find_all_invoice_items_by_invoice_id(3)
  ...
  def test_it_finds_the_first_example_of_invoice_item_by_quantity
    ...
    first_invoice_item = repo.find_invoice_item_by_quantity(5)

    assert_equal [1], [first_invoice_item.id]

    second_invoice_item = repo.find_invoice_item_by_quantity(6)
    assert_equal [2], [second_invoice_item.id]
  ...
  def test_it_finds_all_examples_of_invoice_items_by_quantity
    ...
    invoice_fives = repo.find_all_invoice_items_by_quantity(5)
    invoice_sixes = repo.find_all_invoice_items_by_quantity(6)
    invoice_sevens = repo.find_all_invoice_items_by_quantity(7)
  ...
  def test_it_finds_the_first_example_of_invoice_item_by_unit_price
    ...
    first_invoice_item = repo.find_invoice_item_by_unit_price(13635)

    assert_equal [1], [first_invoice_item.id]

    second_invoice_item = repo.find_invoice_item_by_unit_price(34873)
    assert_equal [2], [second_invoice_item.id]
  ...
  def test_it_finds_all_examples_of_invoice_items_by_unit_price
    ...
    invoice_thirteen_ks = repo.find_all_invoice_items_by_unit_price(13635)
    invoice_thirty_ks = repo.find_all_invoice_items_by_unit_price(34873)
    invoice_fifteen_ks = repo.find_all_invoice_items_by_unit_price(15000)
  ...
  def test_it_finds_the_first_example_of_invoice_item_by_created_at
    ...
    first_created_at = repo.find_invoice_item_by_created_at(Time.now - 5)

    assert_equal [2], [first_created_at.id]

    second_created_at = repo.find_invoice_item_by_created_at(Time.now - 7)
  ...
  def test_it_finds_the_first_example_of_invoice_item_by_updated_at
    ...
    first_updated_at = repo.find_invoice_item_by_name(Time.now - 3)

    assert_equal [1], [first_updated_at.id]

    second_updated_at = repo.find_invoice_item_by_name(Time.now - 5)
